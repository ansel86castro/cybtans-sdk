...
{
	public partial class CubeMap : IReflectorMetadataProvider
	{
		private static readonly CubeMapAccesor __accesor = new CubeMapAccesor();
	...
	public sealed class CubeMapAccesor : IReflectorMetadata
	{
