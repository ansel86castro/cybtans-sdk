...
namespace Cybtans.Tests.RestApi.Controllers
{
	...
	public partial class CustomerServiceController : ControllerBase
	{
		...
		public CustomerServiceController(ICustomerService service,  ILogger<CustomerServiceController> logger, global::Cybtans.AspNetCore.Interceptors.IMessageInterceptor interceptor = null)
		{
			_service = service;
			_logger = logger;
