...
import { CameraController } from '../cybtans.graphics/Behaviors/CameraControllers';
import Frame from '../cybtans.graphics/Frame/Frame';
import { CameraComponent } from '../cybtans.graphics/Frame/CameraComponent';
        ...
        if (invalidated.current === true) {
            if (ref.current) {
                ...
                if (gl) {
                    ...
                    sceneMgr.current = new SceneManager(gl, canvas);
